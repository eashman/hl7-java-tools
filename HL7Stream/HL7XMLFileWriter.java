...
public class HL7XMLFileWriter extends HL7StreamBase implements HL7Stream {
   ...
   private String hl7XMLMessageFileName(HL7Message msg) {
      ...
      if (msgID == null || msgID.isEmpty()) {
         ...
         if (msgTypeCode != null && msgTypeCode[0] != null && !msgTypeCode[0].isEmpty()) {
            msgIDBuffer.append(msgTypeCode[0]);
         } // if

         if (msgEventCode != null && msgEventCode[0] != null && !msgEventCode[0].isEmpty()) {
            if (msgIDBuffer.length() > 0) {
               msgIDBuffer.append(".");
            } // if

            msgIDBuffer.append(msgEventCode[0]);
         } // if

         if (msgDateTime != null && msgDateTime[0] != null && !msgDateTime[0].isEmpty()) {
            if (msgIDBuffer.length() > 0) {
               msgIDBuffer.append(".");
            } // if

            msgIDBuffer.append(msgDateTime[0]);
         } // if
